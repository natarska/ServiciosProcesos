...
import dam.chatserver.ServletAwareConfig;
...
/**
 * @author Arun Gupta
 * // Esta pensado para tener un protocolo rapido en la que se hace llamada asincrona de conexion abierta
 * // Puedes mandar bytes sin hacer base64. Con un websockeet tienes una sesion abierta y
 * // en watsapp tienes notificaciones push. Esta pensado mas para clientes http para javascript abrir conexion
 * // y demas. 
 * // En el ejemplo que pone tenemos en chatserver un javascript y un html 
 */
...
public class MyEndpoint {
    ...
    // La sesion tiene un puntero for (Session s : session.getOpenSessions()) a todas las sesiones
    // Comparas sesiones 
    @OnClose
    ...
    // Aqui coges todos los dats del onOpen de la sesion
    @OnMessage
    public void echoText(String mensaje, Session sessionQueManda) {
        try {
            ...
            // las llaves estan en sesion y el servidor recorre todas las sesiones que tiene por lo que le complica mas
            // 
